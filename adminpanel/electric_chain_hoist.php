...
$msg = "";
    ...
    if ($msg != "") {
     ...
     $query="SELECT t1.*, t2.name , t2.contact_no, t2.gst_no, t2.email_id FROM myc_electric_chain_details as t1 LEFT JOIN myc_customer as t2 ON t1.user_id=t2.id WHERE t1.payment_status=1";
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">STANDARD PRICE LIST-ELECTRIC CHAIN HOIST</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="department-list">
                     <div class="card">
              <div class="card-header">
                <h5 style="font-weight: bold;">STANDARD PRICE LIST-ELECTRIC CHAIN HOIST</h5>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                      ...
                      if(!empty($eot)) {$sn=0;
                        foreach ($eot as $key => $row){$sn++;?>
                            <tr>
                              ...
                              <!-- <td><?php echo $row['traviling_moter_no_val']; ?></td> -->
                              <td><?php echo $row['rate_qnty']; ?></td>
                              <!-- <td><?php echo $row['days']; ?></td> -->
                              <td><?php echo $row['total_amounts_val']; ?></td>
