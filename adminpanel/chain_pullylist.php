...
$msg = "";
    ...
    if ($msg != "") {
     ...
     $query="SELECT t1.*, t2.name , t2.contact_no, t2.gst_no, t2.email_id FROM myc_chain_pully_details as t1 LEFT JOIN myc_customer as t2 ON t1.user_id=t2.id WHERE t1.payment_status=1";
